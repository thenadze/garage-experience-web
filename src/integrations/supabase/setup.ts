...
export function getRLSInstructions() {
  return {
    ...
    steps: [
      ...
      "Allez dans 'Table Editor' et sélectionnez la table 'vehicles'",
      "Cliquez sur 'Authentication' dans le menu de gauche",
      "Sous 'Row Level Security (RLS)', désactivez temporairement RLS en décochant 'Enable RLS'",
      "Pour une solution plus sécurisée, ajoutez plutôt une politique permettant les opérations INSERT/UPDATE"
    ]
  };
}
